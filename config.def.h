...
static pixman_color_t normbarfg = { 0xe0e0, 0xdede, 0xf4f4, 0xffff };
static pixman_color_t normbarbg = { 0x1919, 0x1717, 0x2424, 0xffff };
static pixman_color_t selbarfg  = { 0x1919, 0x1717, 0x2424, 0xffff };
static pixman_color_t selbarbg  = { 0xc4c4, 0xa7a7, 0xe7e7, 0xffff };
...
static const Rule rules[] = {
	...
	{ "org.telegram.desktop",    NULL,            1   << 2,     0,           -1 },
	{ "steam",                   NULL,            1   << 2,     1,           -1 },
	{ "discord",                 NULL,            1   << 2,     0,           -1 },
	{ "mpv",                     NULL,            1   << 3,     0,           -1 },
	{ "org.pwmt.zathura",        NULL,            1   << 4,     0,           -1 },
	{ NULL,                      "ncmpcpp",       1   << 5,     1,           -1 },
	{ "thunderbird",             NULL,            1   << 6,     0,           -1 },
	{ "qBittorrent",             NULL,            1   << 7,     1,           -1 },
};
...
static const char *menucmd[] = { "emenu_run", NULL };
...
static const Key keys[] = {
	...
	{ 0,      XKB_KEY_F11,         spawn,              SHCMD("ddcutil setvcp 10 - 10") },
	{ 0,      XKB_KEY_F12,         spawn,              SHCMD("ddcutil setvcp 10 + 10") },
	{ MODKEY, XKB_KEY_End,         spawn,              SHCMD("mpc seek +5%") },
	{ MODKEY, XKB_KEY_Home,        spawn,              SHCMD("mpc seek -5%") },
	{ 0,      XKB_KEY_Insert,      spawn,              SHCMD("mpc -q toggle") },
	{ MODKEY, XKB_KEY_Insert,      spawn,              SHCMD("mpc -q stop") },
	{ 0,      XKB_KEY_Page_Up,     spawn,              SHCMD("amixer -q set Master 5%+; kill -RTMIN $(cat ~/.cache/pidofbar)") },
	{ 0,      XKB_KEY_Page_Down,   spawn,              SHCMD("amixer -q set Master 5%-; kill -RTMIN $(cat ~/.cache/pidofbar)") },
	{ 0,      XKB_KEY_Pause,	   spawn,              SHCMD("amixer -q set Master toggle; kill -RTMIN+2 $(cat ~/.cache/pidofbar)") },
	{ 0,      XKB_KEY_Scroll_Lock, spawn,              SHCMD("amixer -q set Capture toggle; kill -RTMIN+2 $(cat ~/.cache/pidofbar)") },
