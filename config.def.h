...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT,   XKB_KEY_greater,    tagmon,         {.i = WLR_DIRECTION_RIGHT} },
        ...
        { 0,      XKB_KEY_End,         spawn,              SHCMD("mpc -q next") },
        { 0,      XKB_KEY_Home,        spawn,              SHCMD("mpc -q prev") },
        { 0,      XKB_KEY_Page_Up,     spawn,              SHCMD("amixer -q set Master 5%+") },
        { 0,      XKB_KEY_Page_Down,   spawn,              SHCMD("amixer -q set Master 5%-") },
        { 0,      XKB_KEY_Pause,       spawn,              SHCMD("amixer -q set Master toggle") },
        { 0,      XKB_KEY_Scroll_Lock, spawn,              SHCMD("amixer -q set Capture toggle; pkill -RTMIN+8 waybar") },
